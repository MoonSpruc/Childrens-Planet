(() => {
    ...
    if (document.querySelector(".achievements-about__slider")) new Swiper(".achievements-about__slider", {
        modules: [ Navigation ],
        observer: true,
        observeParents: true,
        slidesPerView: 3,
        ...
        speed: 800,
        navigation: {
            prevEl: ".achievements-about__arrow--left",
            nextEl: ".achievements-about__arrow--right"
        },
        breakpoints: {
            320: {
                slidesPerView: 1,
    ...
    if (document.querySelector(".slider-tabs-academics__0")) new Swiper(".slider-tabs-academics__0", {
        modules: [ Navigation ],
        observer: true,
        observeParents: true,
        slidesPerView: 4,
        ...
        speed: 800,
        navigation: {
            prevEl: ".item-tabs-academics__arrow--left--0",
            nextEl: ".item-tabs-academics__arrow--right--0"
        },
        breakpoints: {
            320: {
                slidesPerView: 1,
    ...
    if (document.querySelector(".slider-tabs-academics__1")) new Swiper(".slider-tabs-academics__1", {
        modules: [ Navigation ],
        observer: true,
        observeParents: true,
        slidesPerView: 4,
        ...
        speed: 800,
        navigation: {
            prevEl: ".item-tabs-academics__arrow--left--1",
            nextEl: ".item-tabs-academics__arrow--right--1"
        },
        breakpoints: {
            320: {
                slidesPerView: 1,
    ...
    if (document.querySelector(".slider-tabs-academics__2")) new Swiper(".slider-tabs-academics__2", {
        modules: [ Navigation ],
        observer: true,
        observeParents: true,
        slidesPerView: 4,
        ...
        speed: 800,
        navigation: {
            prevEl: ".item-tabs-academics__arrow--left--2",
            nextEl: ".item-tabs-academics__arrow--right--2"
        },
        breakpoints: {
            320: {
                slidesPerView: 1,
    ...
    function windowLoad() {
        ...
        function digitsCountersAnimate(digitsCounter) {
            ...
            const startPosition = digitsCounter.innerHTML;
            const startValue = parseFloat(startPosition.replace(/[^\d.]/g, ""));
            const step = timestamp => {
                if (!startTimestamp) startTimestamp = timestamp;
                const progress = Math.min((timestamp - startTimestamp) / duration, 1);
                const animValue = Math.floor(progress * startValue);
                digitsCounter.innerHTML = startPosition.replace(/\d+/, animValue);
        ...
        let observer = new IntersectionObserver(((entries, observer) => {
            entries.forEach((entry => {
                if (entry.isIntersecting) {
                    ...
                    if (digitsCounterItems.length) digitsCounterInit(digitsCounterItems);
                    observer.unobserve(targetElement);
                }
            }));
        }), options);
        let sections = document.querySelectorAll("[data-digits-counter-section]");
    ...
    let formValidate = {
        ...
        formClean(form) {
            ...
            setTimeout((() => {
                ...
                if (andModules.select) {
                    let selects = form.querySelectorAll(".select");
                    if (selects.length) for (let index = 0; index < selects.length; index++) {
                        const select = selects[index].querySelector("select");
                        andModules.select.selectBuild(select);
                    }
                }
            }), 0);
        },
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        const contactButton = document.querySelector(".body-header__button");
        const activeLink = localStorage.getItem("activeLink");
        if (activeLink) {
            const activeMenuLink = document.querySelector(`.menu__link[href="${activeLink}"]`);
            if (activeMenuLink) activeMenuLink.classList.add("_active");
        }
